...
function checkWinConditions() {
    ...
    //X 1, 4, 7 condition.
    else if (arrayIncludes('1X', '4X', '7X')) {drawWinLine(304, 50, 303, 558)}
    //X 2, 5, 8 condition.
...
//This function takes a string marameter of the path you set earlier for
...
//This functiion utilizes HTML canvas to draw win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        //This method clears content from the last loop interatiion.
        ...
        //This conditiion is similar to the one above.
        //This is necessary for the 6, 4, 2 win condition.
        if (x1 <= x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y < y2) { y -= 10; }
...
//This function resets the game in the canvas of a tie or a win.
function resetGame() {
